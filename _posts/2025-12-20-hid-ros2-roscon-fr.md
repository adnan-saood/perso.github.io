...
<div class="row mt-3 mb-3">
    <div class="col-12">
        {% include figure.liquid loading="lazy" path="assets/img/blog/post09.jpg" title="hid_ros2 presentation at ROSCon FR" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
- See the [paxini_ros2]({{ site.baseurl }}/projects/#) project (uses hid_ros2 under the hood)

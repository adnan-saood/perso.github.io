...
<div class="row mt-3 mb-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="lazy" path="assets/img/blog/post08_1.jpg" title="Tactile sensing research" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="lazy" path="assets/img/blog/post08_2.jpg" title="Haptic interface" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="lazy" path="assets/img/blog/post08_3.jpg" title="Research results" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
- [Human-Robot Handshake]({{ site.baseurl }}/projects/#contributing-factors-in-human-robot-handshake)

...
<div class="row mt-3 mb-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="lazy" path="assets/img/blog/post03_1.jpg" title="ICRA 2026 Vienna" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="lazy" path="assets/img/blog/post06.jpg" title="Handshake demonstration" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
**Related:**
- See the [Human-Robot Handshake project]({{ site.baseurl }}/projects/#contributing-factors-in-human-robot-handshake) for full technical details
- Publications: Saood & Tapus (2026), ICRA, Paper ThI1I.171
- See also: [Tactile Array for Humanoid Hand]({{ site.baseurl }}/projects/#tactile-array-for-humanoid-hand) and [Soft Robotic Haptic Interface]({{ site.baseurl }}/projects/#soft-robotic-haptic-interface-for-anxiety-reduction)

...
1. **First meeting with a humanoid robot** (anxiety baseline high)
2. **During collaborative manipulation** (task + social stress)
3. **Comfort and reassurance** (robot as a therapeutic tool)
